                  ...
                  <div class="container ">
                    <nav class="main-nav" role="navigation">
                      <div class="navbar-header text-center">
                        <a href="/">
                          <img src="/images/logo-GC.png" alt="Grey Circle" class="hidden-lg hidden-md" style="width: 90px">
                        </a>   <!--nahrazení obrazového loga ze středu a přesun na kraj-->
                          ...
                          <?php
                                ...
                                echo '<nav class="left-menu">
                                    ...
                                    <!--obsah modálního okna-->
                                      <div id="leftcolumn">
                                        <div class="logo-b">
                                          <img src="https://trello-attachments.s3.amazonaws.com/5585ac604e4d95cb6a64c0a7/96x84/2cfc7267f5564cc3c39bea8607bc3815/logo.png" class="logo-i" />
                                        </div>
                                        <jdoc:include type="modules" name="login" /></div>
                                    <!--otevření modálního okna-->
                                    <a href="#leftcolumn" class="modal modaltest">Pro akcionáře</a>
                                  </nav>';
					                           }
				                       ?>

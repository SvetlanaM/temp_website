  ...
  <html class="no-js" lang="<?php echo $this->language; ?>"> <!--<![endif]-->
    <head>    
      ...
      jQuery(document).ready(function(){
        jQuery( "<div class='i-i'><span class='glyphicon glyphicon-user'></span></div>" ).insertBefore( ".input-small" );
      });
        
      jQuery(document).ready(function(){
        jQuery( "<div class='i-p'><span class='glyphicon glyphicon-queen'></span></div>" ).insertBefore( "input[type='password']" );
      });
      </script>
    </head>
